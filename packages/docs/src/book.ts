...
export const BOOK: readonly BookPart[] = [
  ...
  },
  {
    ...
    title: "Inventory",
    chapters: [
      { chapter: 4, title: "Order quantities: EOQ and (s, S)", slug: "book/order-quantities" },
      {
        chapter: 5,
        title: "One period under uncertainty: the newsvendor",
        slug: "book/newsvendor",
      },
      { chapter: 6, title: "Reviews, lead times and base-stock", slug: "book/base-stock" },
      { chapter: 7, title: "Safety stock and service levels", slug: "book/safety-stock" },
      { chapter: 8, title: "Forecasting", slug: "book/forecasting" },
    ],
  },
  {
    part: 3,
    title: "Networks",
    chapters: [
      { chapter: 9, title: "Supply chains, echelon stock and the bullwhip effect" },
      { chapter: 10, title: "Allocation, fairness and risk pooling" },
      { chapter: 11, title: "Disruptions and resilience" },
    ],
  },
  {
    part: 4,
    title: "Optimisation",
    chapters: [
      { chapter: 12, title: "Linear programming and the transportation problem" },
      { chapter: 13, title: "Network flows and bounds over time" },
      { chapter: 14, title: "Integer problems: loading, relaxations and heuristics" },
      { chapter: 15, title: "Routing and inventory routing" },
    ],
  },
  {
    part: 5,
    title: "Dynamics",
    chapters: [
      { chapter: 16, title: "Feedback control" },
      { chapter: 17, title: "Queues" },
      { chapter: 18, title: "Sequential decisions and dynamic programming" },
    ],
  },
];
