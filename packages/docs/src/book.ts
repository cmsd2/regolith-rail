...
export const BOOK: readonly BookPart[] = [
  {
    ...
    chapters: [
      ...
      { chapter: 2, title: "Randomness and simulation", slug: "book/randomness" },
    ],
  },
  {
    part: 2,
    ...
    chapters: [
      ...
      { chapter: 6, title: "Safety stock and service levels", slug: "book/safety-stock" },
      { chapter: 7, title: "Forecasting", slug: "book/forecasting" },
    ],
  },
  {
    part: 3,
