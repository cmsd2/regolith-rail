...
describe("engine properties", () => {
  it("conserves resources and keeps stock and cargo within bounds at every event", () => {
    fc.assert(
  ...
  it("keeps every other flow's draws unchanged when a consumer is added", () => {
    fc.assert(
      fc.property(
        arbitraryScenario,
        fc.nat(),
