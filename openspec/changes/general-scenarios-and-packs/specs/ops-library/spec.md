...
- **WHEN** a stock point with stock 3000, 2000 on order and 1000 backordered is reviewed by
...
- **WHEN** the same stock point is reviewed by `review = { target = ops.min_max { min = 2000, max = 10000 } }`
