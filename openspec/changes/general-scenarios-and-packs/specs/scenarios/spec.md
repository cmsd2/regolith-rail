...
**Reason**: Scenarios now describe networks of stations joined by arcs; a line is one kind of network.
**Migration**: Format 1 lines are upgraded on load to stations joined in order by arcs (see Format 1
